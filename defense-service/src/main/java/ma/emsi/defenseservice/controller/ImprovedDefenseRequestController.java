...
/**
 * Controller amélioré avec DTOs pour de meilleures performances et sécurité
 */
@RestController
@RequestMapping("/api/defense-service/v2/defense-requests")
public class ImprovedDefenseRequestController {
    ...
    /**
     * Récupérer une demande (DTO sans relations lourdes)
     */
    @GetMapping("/{id}")
